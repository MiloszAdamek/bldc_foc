...
legend({'i_d','i_q','Wartość zadana'}, 'Location','northwest');
% legend({'i_d','i_q'}, 'Location','northwest');

%% ZAPIS
% exportgraphics(gcf, "fig_regulacja_foc.pdf", 'Resolution', 300);
...
% exportgraphics(gcf, "fig_prady_fazowe.pdf", 'Resolution', 300);
